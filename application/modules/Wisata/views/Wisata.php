            ...
            <div class="card-body">
                <div id="toolbar">
                    <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                        <a href="<?=base_url('form_tambah_wisata');?>" class="btn btn-success" title="Tambah Data">
                            <i class="fa fa-plus" style="margin-right: 5px;"></i>
                            Tambah
                        </a>
                        <a href="<?=base_url('form_ubah_wisata/');?>" class="btn btn-warning" id="btnRedir"
                            title="Ubah Data">
                ...
                <div class="table-responsive">
                    <table id="table" class="table table-striped" data-toggle="table" data-toolbar="#toolbar"
                        ...
                        data-page-list="[10, 25, 50, 100, all]" data-url="<?=base_url('Wisata/load_wisata');?>">
                        <thead>
                            <tr style="text-align:center;">
                                <th data-field="state" data-checkbox="true"></th>
                                <th data-formatter="operateFormatter2" data-width="100">Foto</th>
                                <th data-field="nama_wisata" data-sortable="true">Nama</th>
