        ...
        <div class="card">
            <div class="card-body">	      
                <div id="toolbar">
                    ...
                    <a href="<?=base_url('ubah-agenda/');?>" class="btn btn-warning" id="btnRedir" title="Ubah Agenda">
                        <i class="fa fa-edit"></i> Edit
                    </a>
                    <a href="<?=base_url('home/hapusData'); ?>" class="btn btn-danger" id="btnDestroy" title="Hapus Data">
                ...
                <div class="table-responsive">
                    ...
                    data-url="<?=base_url('agenda/load_agenda');?>"
                    >
                    <thead>
                        <tr>
...
<script type="text/javascript">
    ...
    return [
      '<a href="'+row.naskah+'" class="btn btn-primary">',
        'Lihat',
      '</a'
    ].join('')
  }  
