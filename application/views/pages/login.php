			...
			<div class="container">
				<form id="ngepost" class="row row-eq-height lockscreen  mt-5 mb-5">
					...
					<div class="input-group nm-gp">
						...
						<input type="text" class="form-control" name="user" id="emailaddress"  tabindex="1" placeholder="Username" required>
					</div>
					
					<div class="input-group nm-gp">
						<span class="nm-gp-pp"><i class="fas fa-lock"></i></span>
						<input type="password" class="form-control" id="myInput" name="password" tabindex="2" placeholder="Password" required>
					</div>
					<div class="row nm-aic nm-mb-1">
						<div class="col-sm-6 nm-mb-1 nm-mb-sm-0">
							<button type="submit" class="btn btn-primary nm-hvr nm-btn-2">Masuk <span id="loading"></span></button>
						</div>
