    ...
    <head>
        <meta charset="UTF-8">
        <title><?= $title; ?></title>
        <link rel="shortcut icon" href="<?=base_url();?>assets/img/logoasistenku.png">
        ...
        <link rel="stylesheet" href="<?=base_url();?>assets/scss/icons/font-awesome/css/fontawesome-all.css">
        <!-- daterange picker -->
        <link rel="stylesheet" href="<?=base_url();?>assets/daterangepicker/daterangepicker.css">
        <!-- bootstrap datepicker -->
        <link href="<?=base_url('assets/js/table/');?>bootstrap-table.min.css" rel="stylesheet">
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.13/css/select2.min.css" integrity="sha512-nMNlpuaDPrqlEls3IX/Q56H36qvBASwb3ipuo3MxeWbsQB1881ox0cRv7UPTgBlriqoynt35KjEwgGUeUXIPnw==" crossorigin="anonymous" referrerpolicy="no-referrer" />
        <style type="text/css">
            .form-control{border:1px solid#9d9e9e;font-size: 13px;height: 35px}
            td{font-size: 12px;}
            .judul{font-size: 14px;margin:5px 0 5px 0;font-weight: bold;text-transform: uppercase;}
            .besar{font-size: 14px;font-weight: bold;padding-bottom: 3px;padding-top: 3px;}
            .bold{font-weight: bold;}
        </style>
        <!-- END: Custom CSS-->
        <script src="<?=base_url();?>assets/dist/vendors/jquery/jquery-3.3.1.min.js"></script>
        <script src="<?=base_url();?>assets/js/proses.js"></script>
    </head>
    <!-- END Head-->